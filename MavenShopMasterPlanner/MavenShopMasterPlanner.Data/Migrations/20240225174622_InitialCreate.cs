        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlagImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NutritionDetailsId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_NutritionDetails_NutritionDetailsId",
                        column: x => x.NutritionDetailsId,
                        principalTable: "NutritionDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    AllergenCategoryId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Allergens_AllergenCategories_AllergenCategoryId",
                        column: x => x.AllergenCategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharedShoppingLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SharedShoppingLists_ShoppingList_ShoppingListId",
                        column: x => x.ShoppingListId,
                        principalTable: "ShoppingList",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SharedShoppingLists_Users_SharedWithUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quantity = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsPutchased = table.Column<bool>(type: "bit", nullable: false),
                    ShoppingListId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Allergens_AllergenCategoryId",
                table: "Allergens",
                column: "AllergenCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_NutritionDetailsId",
                table: "Products",
                column: "NutritionDetailsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedShoppingLists_SharedWithUserId",
                table: "SharedShoppingLists",
                column: "SharedWithUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SharedShoppingLists_ShoppingListId",
                table: "SharedShoppingLists",
